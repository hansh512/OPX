...
Param([Parameter(Mandatory = $true, Position = 0)]
        [ArgumentCompleter( {  
            ...
            $CommandAst,
            $FakeBoundParameters )           
            $cfgList=($__CMM_ModuleData.GetConfigerationList($__OLX_1_0_0_0.ModuleName,$__OLX_1_0_0_0.ModuleVersion,$Global:SkipTemplateVersionFiltering));
...
Param([Parameter(Mandatory = $true, Position = 0)]
    ...
    setActiveConfig -ConfigName $Configuration -Version ($__OLX_1_0_0_0.ModuleVersion);
