...
function getNewestExchangeServer
{
    ...
    { 
        $pL=@{
            LDAPFilter='(objectClass=msExchExchangeServer)'; #'(&((objectClass=msExchExchangeServer)(!(objectClass=msExchExchangeTransportServer))))'; 
...
function writeTolog
{
    ...
    begin {        
        ...
        #$logFileName=([System.IO.Path]::Combine($script:LogFileDir,('Log_')+($LogDateTime.Split(' ')[0].replace('/','-').replace('.','-'))+'.log'));
...
Param([Parameter(Mandatory = $true, Position = 0)][array]$CallStack,
    ...
    {                        
        ...
        if ($ExitLogEntry)
        {
            ...
            #$ParamList.EventID=$INFO_CmdletFinished;
            [void](writeToLog @ParamList)
...
{        
    getModuleData () {
        ...
        $this.PSObject.Properties.Add(
            (New-Object PSScriptProperty 'VirtualDirCfgFileName', {$this._VirtualDirCfgFileNamePath})
        ) # end logDir
        $this.PSObject.Properties.Add(
    ...
    hidden [string]$_VirtualDirCfgFileNamePath=$Script:VirtualDirCfgFileNamePath;    
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUOnvkm9V+MHK7SCOVDCgzJRAM
# GW6gggXxMIIF7TCCBNWgAwIBAgITGwAAAEVNRiQcpqxVgwAAAAAARTANBgkqhkiG
...
# gjcCAQsxDjAMBgorBgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBTvjbEcgR8TfmPk
# U6MwGkBLKx8o/zANBgkqhkiG9w0BAQEFAASCAQBDV6rjz827JnUA6BxFA9PU9XpM
# EIWDBvRyLSSCOF6bz5bgATpYIx9VVMT6xzELUzUloyeDpdEfulzPhi6T74AiDdX0
# UVqc+g7UycTUFlRRaomYE6iXuEb0m7jiyB8gd62PRs0e4uX3GoRTahK+wAUE9IQ5
# UUy4eM1aGWKQMbYh2y23ggYYs9/LYcvmeQ10HStuhhiWnz3HwAIYSj+2KFZirhBT
# WXgCw4OgLr6pOnjW5O1P9wmHgijKh82gPLF0Qjv4tSkEyvz5lhH2OV3cfC7U+hTW
# uBwhtWGPF3q4GQWhaCH+2LrfjvLrHNKjSMo7GsjFUK0jDKpTb7To0W9O7aLr
